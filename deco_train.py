...
if init_from == 'scratch':
    raise Exception("deco_train assumes you have a pretrained model to finetune, use train.py for from-scratch training")
    ...
    model = GPT(gptconf)
    # swap linear for SVD linear
    replace_linear_with_svd(model, exceptions=('lm_head'))
    # load the state dict
...
if master_process:
    pruner_args = {
        ...
        'final_threshold': prune_final_threshold,
        'beta1': prune_beta1,
        'beta2': prune_beta2,
        'deltaT': prune_deltaT,
